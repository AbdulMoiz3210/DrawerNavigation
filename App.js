...
import { Container, Header, Left, Icon, Right, Title, Content ,Body , Button , Card , CardItem} from 'native-base';
 ...
 class Home extends React.Component {
  render () {
    ...
    <Image source = {require('./abdulmoiz.jpg')} style={styles.mypic} />
    <Text style = {styles.size}>Abdul Moiz</Text>
    <Text style = {styles.expertise}>Web Developer | Mobile App Developer | Virtual Assistant</Text>
   </View>
   </ImageBackground>
      </Container> 
    );
 ...
 class Education extends React.Component {
  ...
  <Icon name = "menu"onPress = { () => this.props.navigation.openDrawer()}/>
    ...
    <Body style = {{marginTop : 230 }}>
      <Text style = {styles.size1}>Matriculation From The Educators</Text>
      <Text style = {styles.size1}>Intermediate From DJ Sindh Govt .  Science College</Text>
      <Text style = {styles.size1}>Bachlors In Computer Science(BCS) From MAJU</Text>
    </Body>
    </ImageBackground>
  </Container>
    );
    ...
    return (
      ...
      <Title styles = {{justifyContent: 'center'}}> CONTACT</Title>
        ...
        <View style = {{marginTop : 200}}>
          <Button block dark>
            <Text style = {{color : '#fff'}} onPress={ ()=> Linking.openURL('https://github.com/AbdulMoiz3210') }>Github</Text>
          </Button>
          </View>
          </ImageBackground>
      </Container>
